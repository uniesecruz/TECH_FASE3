...
# Mapeamento inverso manual (assumindo drop='first' com ['<=50K', '>50K'])
...
st.title("📊 Análise de Classificação com CSV e Pipeline")

arquivo = st.file_uploader("📁 Faça upload do arquivo CSV com a coluna 'income'", type=["csv"])
...
if arquivo:
    ...
    if 'income' not in df.columns:
        st.error("A coluna 'income' não foi encontrada no CSV.")
    else:
        # Define X e y
